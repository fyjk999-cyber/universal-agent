...
| CHAPTER 7 | Additional Domains | **PARTIAL**（Railway LIVE READY ✅） | **Railway：RAILWAY_LIVE_READY = True**（FR-110~117 全达成：Raw/Normalize/EntityKey/Scoring/Verify + 12306 Live 源 + RailwayScanCoordinator 全流程实测 上海→杭州东 20 raw→机会→通知）；Ecommerce/Food 仍仅 Raw+normalize+entity_key |
